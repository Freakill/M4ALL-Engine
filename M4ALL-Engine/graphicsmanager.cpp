...
void GraphicsManager::getProjectionMatrix(D3DXMATRIX& projectionMatrix)
{
	projectionMatrix = projectionMatrix_;
	return;
}

void GraphicsManager::getWorldMatrix(D3DXMATRIX& worldMatrix)
{
	worldMatrix = worldMatrix_;
	return;
}

void GraphicsManager::getOrthoMatrix(D3DXMATRIX& orthoMatrix)
{
