...
bool ImageClass::setup(ID3D11Device* device, int screenWidth, int screenHeight, const std::string& textureFilename, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
bool ImageClass::draw(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
	bool result;
