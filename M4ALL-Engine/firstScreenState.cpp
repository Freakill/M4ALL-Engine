...
bool FirstScreenState::setup(ApplicationManager* appManager, GraphicsManager* graphicsManager, InputManager * inputManager, HWND windowHandler)
{
	...
	if(!background_->setup(graphicsManager_->getDevice(), screenWidth, screenHeight, "../M4ALL-Engine/data/fondo.dds", screenWidth, screenHeight))
	{
...
void FirstScreenState::Notify(InputManager* notifier, int arg)
{
	switch(arg){
		case 13:
			{
